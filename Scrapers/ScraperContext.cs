...
internal class ScraperContext {
	...
	public Task<(IEnumerable<string>, IEnumerable<string>)> ExecuteStrategy(Order order, string tempFolder, params Configuration[] configurations) => _scraperStrategy!.Execute(order, tempFolder, configurations);
}